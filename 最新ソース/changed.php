...
$id = $_SESSION["id"];
    ...
    //選択アイテムでUPDATE
    $stmt = $pdo->prepare('UPDATE AVATAR_USER_VISUAL SET USER_ID = :id, KAO = :kao, KAMI = :kami, HUKU = :huku, ACCESSORY = :akuse,KUTU = :kutu, MOCHIMONO = :mochimono ,HADA = :hada WHERE USER_ID = :id');
