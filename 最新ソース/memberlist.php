...
div.container { /* div.container になるようにPHPを書き換えないと */
    position: relative;
    margin: 5px;
    width: 520px;
    height: 307px;
...
echo    "<tbody>";
echo        "<tr>";
echo            "<th><font>職位</font></th>";
echo            "<td><font>".$shokui."</font></td>";
echo        "</tr>";
echo        "<tr>";
echo            "<th><font>なまえ</font></th>";
echo            "<td><font>".$name."</font></td>";
echo        "</tr>";
echo        "<tr>";
echo            "<th><font>性別</font></th>";
echo            "<td><font>".$seibetu."</font></td>";
echo        "</tr>";
echo        "<tr>";
echo            "<th><font>職業</font></th>";
echo            "<td><font>".$job."</font></td>";
echo        "</tr>";
echo        "<tr>";
echo            "<th><font>金貨/ポイント</font></th>";
echo            "<td><font>".$sirudoru."枚/".$totalPoint."PT</font></td>";
echo        "</tr>";
echo        "<tr>";
echo        "<th colspan=\"2\"><font>自己紹介</font></th>";
echo        "</tr>";
echo        "<tr>";
